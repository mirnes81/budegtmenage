...
async function seed() {
  ...
  const expenseCategories = [
    { name: 'Loyer/Hypothèque', icon: 'home', color: '#ef4444', type: 'expense', group_name: 'Logement', order_index: 0 },
    { name: 'Charges PPE', icon: 'building', color: '#f97316', type: 'expense', group_name: 'Logement', order_index: 1 },
    { name: 'Électricité', icon: 'zap', color: '#eab308', type: 'expense', group_name: 'Logement', order_index: 2 },
    { name: 'Eau/Déchets', icon: 'droplet', color: '#06b6d4', type: 'expense', group_name: 'Logement', order_index: 3 },
    { name: 'Internet/Mobile', icon: 'wifi', color: '#8b5cf6', type: 'expense', group_name: 'Logement', order_index: 4 },
    { name: 'Assurances ménage/RC', icon: 'shield', color: '#ec4899', type: 'expense', group_name: 'Logement', order_index: 5 },
    { name: 'Entretien/Réparations', icon: 'wrench', color: '#6b7280', type: 'expense', group_name: 'Logement', order_index: 6 },
    { name: 'Travaux/Rénovation', icon: 'hammer', color: '#78716c', type: 'expense', group_name: 'Logement', order_index: 7 },
    { name: 'Essence/Recharge', icon: 'fuel', color: '#dc2626', type: 'expense', group_name: 'Transports', order_index: 8 },
    { name: 'Assurance auto', icon: 'car', color: '#ea580c', type: 'expense', group_name: 'Transports', order_index: 9 },
    { name: 'Entretien/Pneus', icon: 'wrench', color: '#ca8a04', type: 'expense', group_name: 'Transports', order_index: 10 },
    { name: 'Parking', icon: 'square-parking', color: '#65a30d', type: 'expense', group_name: 'Transports', order_index: 11 },
    { name: 'Transports publics', icon: 'train', color: '#0891b2', type: 'expense', group_name: 'Transports', order_index: 12 },
    { name: 'LAMal', icon: 'heart', color: '#e11d48', type: 'expense', group_name: 'Santé', order_index: 13 },
    { name: 'Complémentaire', icon: 'heart-pulse', color: '#be123c', type: 'expense', group_name: 'Santé', order_index: 14 },
    { name: 'Médecin/Pharmacie/Dentiste', icon: 'pill', color: '#f43f5e', type: 'expense', group_name: 'Santé', order_index: 15 },
    { name: 'École/Crèche', icon: 'school', color: '#7c3aed', type: 'expense', group_name: 'Famille', order_index: 16 },
    { name: 'Activités enfants', icon: 'party-popper', color: '#a855f7', type: 'expense', group_name: 'Famille', order_index: 17 },
    { name: 'Vêtements enfants', icon: 'shirt', color: '#c084fc', type: 'expense', group_name: 'Famille', order_index: 18 },
    { name: 'Courses', icon: 'shopping-cart', color: '#10b981', type: 'expense', group_name: 'Vie courante', order_index: 19 },
    { name: 'Restaurants', icon: 'utensils', color: '#f59e0b', type: 'expense', group_name: 'Vie courante', order_index: 20 },
    { name: 'Loisirs', icon: 'gamepad-2', color: '#06b6d4', type: 'expense', group_name: 'Vie courante', order_index: 21 },
    { name: 'Abonnements', icon: 'repeat', color: '#8b5cf6', type: 'expense', group_name: 'Vie courante', order_index: 22 },
    { name: 'Impôts (acomptes)', icon: 'landmark', color: '#991b1b', type: 'expense', group_name: 'Finance', order_index: 23 },
    { name: 'Frais bancaires', icon: 'circle-dollar-sign', color: '#92400e', type: 'expense', group_name: 'Finance', order_index: 24 },
    { name: 'Épargne', icon: 'piggy-bank', color: '#166534', type: 'expense', group_name: 'Finance', order_index: 25 },
  ];

  const incomeCategories = [
    { name: 'Salaire', icon: 'banknote', color: '#10b981', type: 'income', group_name: 'Revenus', order_index: 0 },
    { name: 'Allocations', icon: 'gift', color: '#14b8a6', type: 'income', group_name: 'Revenus', order_index: 1 },
    { name: 'Remboursements', icon: 'undo-2', color: '#06b6d4', type: 'income', group_name: 'Revenus', order_index: 2 },
    { name: 'Autres revenus', icon: 'plus-circle', color: '#0ea5e9', type: 'income', group_name: 'Revenus', order_index: 3 },
  ];
